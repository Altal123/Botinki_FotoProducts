...
//Написать программу, которая копирует все файлы из заданного каталога и подкаталогов в целевой, 
//при этом переименовывая их в случайном порядке, назначая имена файлам из числовой 
//последовательности от 1 до N, где N — это общее количество файлов в каталоге и подкаталогах. 
